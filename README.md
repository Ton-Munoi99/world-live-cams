...
เว็บดูกล้องถ่ายทอดสด 54 ตัวทั่วโลก — ไฟล์เดียว ไม่ต้อง build ไม่มี dependency

**เดโม:** https://world-live-cams.netlify.app (ต้องใส่รหัสผ่าน)

| หมวด | จำนวน | ตัวอย่าง |
|---|---|---|
| ไทย | 19 | กรุงเทพ 11, เกาะสมุย 3, หัวหิน, พัทยา, เกาะเต่า, เกาะเสม็ด, เกาะช้าง, เกาะพะงัน |
